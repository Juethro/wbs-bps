...
import DetailValidatorProgres from "../PopupDetail/DetailValidatorProgres";
...
function TeknisProgres(){
    ...
    const fetchData = async () => {
        try {
          const response = await fetch('/dashboard/validator/data/progres'); // Mengganti dengan endpoint yang sesuai di Laravel Anda
    ...
    const dataAdministratif = pengaduanData.filter(item => item.jenis_masalah === '1');
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                {currentPosts.map((item) => (
                    ...
                    <td className="px-6 py-4">
                        <DetailValidatorProgres dataAdministratif={item}/>
                    </td>
                    </tr>
                ))}
                </tbody>
